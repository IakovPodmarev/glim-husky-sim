# launch file with added action which sets 30 sec timeout for joint_state_broadcaster, without this action (default timeout is 5 seconds) it might timeout before gazebo launches and robot couldn't be controlled
...
# added action
    timeout = Node(
                    ...
                    executable='spawner',
                    arguments=['--switch-timeout', '30', 'joint_state_broadcaster'],
                    namespace='a200_0000',
                    output='screen'
                )
